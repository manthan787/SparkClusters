...
We think that this performance is reasonable and we were able to verify the results by visualizing them. Compared to Agglomerative clustering, KMeans performs significantly better. We discuss more on Agglomerative Clustering performance in the next section.
