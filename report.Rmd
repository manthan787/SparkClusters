...
p+labs(x = "Cluster",y="Loudness",col = "Cluster", title="Figure 1.1. Fuzzy Loudness: Small Dataset")+ scale_color_manual(labels=c("Loud","Quiet","Medium"),values=c("pink","green","blue"))
```
...
p<- ggplot(values, aes(x=V1, y=V2)) +
  geom_jitter(aes(col = values$V1))
p+labs(x = "Cluster",y="Loudness",col = "Cluster", title="Figure 1.2. Fuzzy Loudness: Big Dataset")+ scale_color_manual(labels=c("Loud","Quiet","Medium"),values=c("pink","green","blue"))
```
...
p+ labs(x = "Cluster",y="Length",col = "Cluster", title="Figure 3.1. Fuzzy Length: Small Dataset")+ scale_color_manual(labels=c("Long","Short","Medium"),values=c("pink","green","blue"))
```
...
p<- ggplot(lvalues, aes(x=V1, y=V2)) + 
  geom_jitter(aes(col = lvalues$V1))
p+ labs(x = "Cluster",y="Length",col = "Cluster", title="Figure 3.2. Fuzzy Length: Big Dataset")+ scale_color_manual(labels=c("Long","Short","Medium"),values=c("pink","green","blue"))
```
...
p+ labs(x = "Cluster",y="Tempo",col = "Cluster", title="Figure 5.1. Fuzzy Tempo: Small Dataset")+ scale_color_manual(labels=c("Fast","Slow","Medium"),values=c("pink","green","blue"))
```
...
p<- ggplot(tvalues, aes(x=V1, y=V2)) + 
  geom_jitter(aes(col = tvalues$V1))
p+ labs(x = "Cluster",y="Tempo",col = "Cluster", title="Figure 5.2. Fuzzy Tempo: Big Dataset")+ scale_color_manual(labels=c("Fast","Slow","Medium"),values=c("pink","green","blue"))
```
...
p+ labs(x = "Cluster",y="Hotness",col = "Cluster", title="Figure 7.1. Fuzzy Tempo: Small Dataset (Min, Max, Mean) centroids")+ scale_color_manual(labels=c("Hot","Cool","Mild"),values=c("pink","green","blue"))
```
...
p<- ggplot(hvalues, aes(x=V1, y=V2)) + 
  geom_jitter(aes(col = hvalues$V1))
p+ labs(x = "Cluster",y="Hotness",col = "Cluster", title="Figure 7.2. Fuzzy Tempo: Small Dataset randomly chosen centroids")+ scale_color_manual(labels=c("Mild","Hot","Cold"),values=c("pink","green","blue"))
```
...
p+ labs(x = "Song Hotness",y="Artist Hotness",col = "Cluster", title="Figure 9.1. Combined Hotness: Small Dataset")
```
...
p<- ggplot(cvalues, aes(x=V2, y=V3)) + 
  geom_jitter(aes(col = cvalues$V1))
p+ labs(x = "Song Hotness",y="Artist Hotness",col = "Cluster", title="Figure 9.1. Combined Hotness: Big Dataset")
```
